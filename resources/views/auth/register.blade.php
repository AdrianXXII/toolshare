                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        {{--<div class="form-group{{ $errors->has('Company') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="company" value="{{ old('company') }}">
                        ...
                        <div class="form-group{{ $errors->has('Zip') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Zip</label>

                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="zip" value="{{ old('zip') }}">
