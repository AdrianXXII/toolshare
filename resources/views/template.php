...
<div class="wrapper">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown messages-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="header">Sie haben 4 neue Nachrichten</li>
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            ...
                                            <!-- The message -->
                                            <p>Dempro wird genial!</p>
                                        </a>
                                    </li><!-- end message -->
                                </ul><!-- /.menu -->
                            </li>
                            <li class="footer"><a href="#">Zeige alle Nachrichten</a></li>
                        </ul>
                    </li><!-- /.messages-menu -->
                    ...
                    <li class="dropdown notifications-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="header">Sie haben 10 Benachrichtigungen</li>
                            <li>
                                <!-- Inner Menu: contains the notifications -->
                                <ul class="menu">
                                    <li><!-- start notification -->
                                        <a href="#">
                                            <i class="fa fa-users text-aqua"></i> 5 neue Mitglieder sind heute beigetreten
                                        </a>
                                    </li><!-- end notification -->
                                </ul>
                            </li>
                            <li class="footer"><a href="#">Alles anzeigen</a></li>
                        </ul>
                    </li>
                    <!-- Tasks Menu -->
                    <li class="dropdown tasks-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="header">Sie haben 9 neue Aufgaben</li>
                            <li>
                            ...
                            <li class="footer">
                                <a href="#">Alle Aufgaben anzeigen</a>
                            </li>
                        </ul>
                    </li>
                    <!-- User Account Menu -->
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">Reto Aeschbacher</span>
                        </a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                <p>
                                    Reto Aeschbacher - IT-Allrounder
                                    <small>Mitglied seit Apr. 2016</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Seitenkopf
                <small>Optionale Beschreibung</small>
            </h1>
            <ol class="breadcrumb">
